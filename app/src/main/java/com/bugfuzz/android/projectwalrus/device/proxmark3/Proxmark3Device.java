...
public class Proxmark3Device extends UsbSerialCardDevice<Proxmark3Command>
    ...
    @Override
    public MifareCardData.Block readMifareBlock(final int blockNumber, MifareCardData.Key key,
            ...
            try {
                ...
                while (shouldContinueCallback.shouldContinue()) {
                    ...
                    if (result.args[0] != 0) {
                        ...
                        bb.get(uidBytes);
                        iso14443APart.uid = new BigInteger(ArrayUtils.subarray(uidBytes, 0,
                                bb.get()));
                        ...
                        if (!iso14443APart.equals(lastIso14443APart)) {
                            ...
                            for (MifareReadStep readStep : readSteps) {
                                ...
                                proxmark3Device.setStatus("Reading - step #" + i++);
